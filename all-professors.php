...
<body>
    ...
    <div class="all-content-wrapper">
        ...
        <div class="contacts-area mg-b-15" bis_skin_checked="1">
            <div class="container-fluid" bis_skin_checked="1">
                <div class="row" bis_skin_checked="1">
                    <div class="col-lg-3 col-md-6 col-sm-6 col-xs-12" bis_skin_checked="1">
                        <div class="hpanel hblue contact-panel contact-panel-cs responsive-mg-b-30"
                            bis_skin_checked="1">
                            <div class="panel-body custom-panel-jw" bis_skin_checked="1">
                                <div class="social-media-in" bis_skin_checked="1">
                            ...
                            <div class="panel-footer contact-footer" bis_skin_checked="1">
                                <div class="professor-stds-int" bis_skin_checked="1">
                                    <div class="professor-stds" bis_skin_checked="1">
                                        <div class="contact-stat" bis_skin_checked="1"><span>Likes: </span>
                                            <strong>956</strong></div>
                                    </div>
                                    <div class="professor-stds" bis_skin_checked="1">
                                        <div class="contact-stat" bis_skin_checked="1"><span>Comments: </span>
                                            <strong>350</strong></div>
                                    </div>
                                    <div class="professor-stds" bis_skin_checked="1">
                                        <div class="contact-stat" bis_skin_checked="1"><span>Views: </span>
                ...
                <div class="row" bis_skin_checked="1">
                    <div class="col-lg-3 col-md-6 col-sm-6 col-xs-12" bis_skin_checked="1">
                        <div class="hpanel hblue contact-panel contact-panel-cs mg-t-30" bis_skin_checked="1">
                            <div class="panel-body custom-panel-jw" bis_skin_checked="1">
                                <div class="social-media-in" bis_skin_checked="1">
                                    <a href="#"><i class="fa fa-facebook"></i></a>
                                    <a href="#"><i class="fa fa-twitter"></i></a>
