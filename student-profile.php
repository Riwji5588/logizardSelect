...
<body>
    ...
    <div class="all-content-wrapper">
        ...
        <div class="single-pro-review-area mt-t-30 mg-b-15" bis_skin_checked="1">
            <div class="container-fluid" bis_skin_checked="1">
                <div class="row" bis_skin_checked="1">
                    <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12" bis_skin_checked="1">
                        <div class="profile-info-inner" bis_skin_checked="1">
                            <div class="profile-img" bis_skin_checked="1">
                                <img src="img/profile/1.jpg" alt="">
                            </div>
                            <div class="profile-details-hr" bis_skin_checked="1">
                                <div class="row" bis_skin_checked="1">
                                    <div class="col-lg-6 col-md-12 col-sm-12 col-xs-6" bis_skin_checked="1">
                                        <div class="address-hr" bis_skin_checked="1">
                                            <p><b>Name</b><br> Fly Zend</p>
                                        </div>
                                    </div>
                                    <div class="col-lg-6 col-md-12 col-sm-12 col-xs-6" bis_skin_checked="1">
                                        <div class="address-hr tb-sm-res-d-n dps-tb-ntn" bis_skin_checked="1">
                                ...
                                <div class="row" bis_skin_checked="1">
                                    <div class="col-lg-4 col-md-4 col-sm-4 col-xs-4" bis_skin_checked="1">
                                        <div class="address-hr" bis_skin_checked="1">
                    ...
                    <div class="col-lg-8 col-md-8 col-sm-8 col-xs-12" bis_skin_checked="1">
                        <div class="product-payment-inner-st res-mg-t-30 analysis-progrebar-ctn" bis_skin_checked="1">
                            ...
                            <div id="myTabContent" class="tab-content custom-product-edit st-prf-pro"
                                ...
                                <div class="product-tab-list tab-pane fade active in" id="description"
                                    ...
                                    <div class="row" bis_skin_checked="1">
                                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12" bis_skin_checked="1">
                                            <div class="review-content-section" bis_skin_checked="1">
                                                <div class="row" bis_skin_checked="1">
                                                    <div class="col-lg-3 col-md-3 col-sm-3 col-xs-6"
                                                        bis_skin_checked="1">
                                                        <div class="address-hr biography" bis_skin_checked="1">
                                                ...
                                                <div class="row" bis_skin_checked="1">
                                                    <div class="col-lg-12" bis_skin_checked="1">
                                                        <div class="content-profile" bis_skin_checked="1">
                                                ...
                                                <div class="row mg-b-15" bis_skin_checked="1">
                                                    <div class="col-lg-12" bis_skin_checked="1">
                                                        <div class="row" bis_skin_checked="1">
                                                            <div class="col-lg-12" bis_skin_checked="1">
                                                                <div class="skill-title" bis_skin_checked="1">
                                                                    <h2>Skill Set</h2>
                                                                    <hr>
                                                                </div>
                                                            </div>
                                                        </div>
                                                        <div class="progress-skill" bis_skin_checked="1">
                                                            <h2>Java</h2>
                                                            <div class="progress progress-mini" bis_skin_checked="1">
                                                                <div style="width: 90%;"
                                                ...
                                                <div class="row mg-b-15" bis_skin_checked="1">
                                                    <div class="col-lg-12" bis_skin_checked="1">
                                                        ...
                                                        <div class="ex-pro" bis_skin_checked="1">
                                                            <ul>
                                ...
                                <div class="product-tab-list tab-pane fade" id="reviews" bis_skin_checked="1">
                                    <div class="row" bis_skin_checked="1">
                                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12" bis_skin_checked="1">
                                            <div class="review-content-section" bis_skin_checked="1">
                                                <div class="chat-discussion" style="height: auto" bis_skin_checked="1">
                                                    <div class="chat-message" bis_skin_checked="1">
                                                        <div class="profile-hdtc" bis_skin_checked="1">
                                                            <img class="message-avatar" src="img/contact/1.jpg" alt="">
                                                        </div>
                                                        <div class="message" bis_skin_checked="1">
                                                            ...
                                                            <div class="m-t-md mg-t-10" bis_skin_checked="1">
                                ...
                                <div class="product-tab-list tab-pane fade" id="INFORMATION" bis_skin_checked="1">
                                    <div class="row" bis_skin_checked="1">
                                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12" bis_skin_checked="1">
                                            <div class="review-content-section" bis_skin_checked="1">
                                                <div class="row" bis_skin_checked="1">
                                                    <div class="col-lg-6" bis_skin_checked="1">
                                                        ...
                                                        <div class="file-upload-inner ts-forms" bis_skin_checked="1">
                                                            <div class="input prepend-big-btn" bis_skin_checked="1">
                                                                <label class="icon-right" for="prepend-big-btn">
                                                                    <i class="fa fa-download"></i>
                                                                </label>
                                                                <div class="file-button" bis_skin_checked="1">
                                                                    Browse
                                                                    <input type="file"
                                                ...
                                                <div class="row" bis_skin_checked="1">
                                                    <div class="col-lg-12" bis_skin_checked="1">
                                                        <div class="payment-adress mg-t-15" bis_skin_checked="1">
                                                            <button type="submit"
